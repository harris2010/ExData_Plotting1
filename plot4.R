...
glblReactPower <- as.numeric(subSetDat$Global_reactive_power)
...
plot(datetime, glblActPower, type="l", xlab="", ylab="Global Active Power", cex=0.2)
...
plot(datetime, glblReactPower, type="l", xlab="datetime", ylab="Global_reactive_power")
